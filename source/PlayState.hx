...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		switch (songLowercase)
		{
			...
			case 'darling':
				dialogue = CoolUtil.coolTextFile(Paths.txt('darling/Dialogue'));
			case 'blossoms':
				dialogue = CoolUtil.coolTextFile(Paths.txt('blossoms/Dialogue'));
			case 'vines':
				dialogue = CoolUtil.coolTextFile(Paths.txt('vines/Dialogue'));
		}
		...
		if (SONG.stage == null) {
			switch(storyWeek)
			{
				...
				case 6: if (songLowercase == 'vines') {stageCheck = 'schoolEvil';} else {stageCheck = 'school';}
		...
		healthBar.createFilledBar(0xFF696969, 0xFFA9A9A9);
		// healthBar
		add(healthBar);
	...
	function schoolIntro(?dialogueBox:DialogueBox):Void
	{
		...
		if (StringTools.replace(PlayState.SONG.song, " ", "-").toLowerCase() == 'roses' || StringTools.replace(PlayState.SONG.song, " ", "-").toLowerCase() == 'vines')
		{
			remove(black);

			if (StringTools.replace(PlayState.SONG.song, " ", "-").toLowerCase() == 'vines')
			{
				add(red);
			}
		}
	...
	override public function update(elapsed:Float)
	{
		...
		if (generatedMusic && PlayState.SONG.notes[Std.int(curStep / 16)] != null)
		{
			...
			if (PlayState.SONG.notes[Std.int(curStep / 16)].mustHitSection && camFollow.x != boyfriend.getMidpoint().x - 300)
			{
				var offsetX = 0;
				var offsetY = 0;
				#if windows
	...
	*/
	...
	override function beatHit()
	{
		...
		if (curBeat % 8 == 7 && curSong == 'FanceeBo')
		{
